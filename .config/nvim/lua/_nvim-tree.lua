...
local function my_on_attach(bufnr)
  ...
  local function openfile_closetree()
    api.node.open.edit()
    vim.api.nvim_command('NvimTreeClose')
  end
  --vim.keymap.set('n', 'i', api.tree.expand_all, opts('Expand All'))
  vim.keymap.set('n', 'h', openfile_closetree, opts('Collapse'))
  ...
  vim.keymap.set('n', '<C-e>', api.node.navigate.sibling.prev, opts('Previous Sibling'))
