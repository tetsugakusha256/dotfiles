...
--
myWorkspaces = ["1: code","2: web","3: term","4: media","5: notes"] ++ map show [5..9]
...
myFont      = "xft:RobotoMono Nerd Font Mono:size=9:bold:antialias=true"
myBigFont   = "xft:RobotoMono Nerd Font Mono:size=9:bold:antialias=true"
myWideFont  = "xft:RobotoMono Nerd Font Mono:"
